...
from nano_emox.common.dist_utils import get_rank, get_world_size, is_main_process, is_dist_avail_and_initialized
...
class BaseTask:
    ...
    def setup_task(cls, **kwargs):
        return cls() # 'nano_emox.tasks.video_text_pretrain.VideoTextPretrainTask'
